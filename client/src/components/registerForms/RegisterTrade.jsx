...
export const RegisterTrade = () => {
  ...
  const RegisterTradeSchema = Yup.object({
  ...
  const formik = useFormik({
    validationSchema: RegisterTradeSchema,
    initialValues: {
      businessName: '',
      firstName: '',
      lastName: '',
      ...
      <Form onSubmit={formik.handleSubmit}>
        ...
        <Form.Group className='mb-3'>
          <Form.Label htmlFor='vatNumber'>
            VAT Number{' '}
            <span className='vat'>(leave blank if not VAT registered)</span>
          </Form.Label>
          <Form.Control
            id='vatNumber'
            name='vatNumber'
